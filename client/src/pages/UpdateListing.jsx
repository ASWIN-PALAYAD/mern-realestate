    ...
    const {currentUser} = useSelector(state=> state.user)
     ...
     useEffect(() => {
        const fetchListing = async() => {
            ...
            const {data} = await axios.get(`/api/listing/getSingleListing/${listingId}`);
     ...
     const handleSubmit = async(e) => {
        ...
        try {
            ...
            setError(false);
            setLoading(true);
            const {data} = await axios.post(`/api/listing/update/${params.listingId}`,{...formData,userRef:currentUser._id});
            setLoading(false);
        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4' >
                <div className='flex flex-col gap-4 flex-1'>
                    <input type="text" placeholder='Name' className='border p-3 rounded-lg' id='name' maxLength={'62'} minLength={'3'}
                        required 
                    ...
                    <div className='flex flex-wrap gap-6'>
                        <div className='flex items-center gap-2'>
                            <input type="number" id='bedrooms' min={'0'} max={'10'} required
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className='flex  gap-4'>
                        <input className='p-3 border border-gray-400 rounded w-full ' type="file" id='images'
                    ...
                    <button disabled={loading || uploading} className='p-4 bg-slate-700 text-white rounded-lg uppercase hover:opacity-25 disabled:opacity-80'>
